    ...
    *,
    ...
    if news_context:
        ...
        parts.append(
            ...
            "      - <ponto 3>\n"
            "\n"
            "- BG_IMAGE: OBRIGATÓRIO em news. NUNCA devolva vazio. Para corrida\n"
            "  feminina/maratona use 'marathon_finish_line'. Para corrida geral use\n"
            "  'track_sprint_athlete' ou 'trail_running_effort'. Para natação use\n"
            "  'swimmer_pool_training'. Para fisioterapia/lesão use\n"
            "  'running_injury_physiotherapy'. Para wearables/dados use\n"
            "  'smartwatch_running_watch'. Se a notícia for de tema sem imagem\n"
            "  exata no banco (ex: ciclismo, triathlon, hyrox), escolha a MAIS\n"
            "  PRÓXIMA (ex: 'track_sprint_athlete' pra esforço atlético genérico)\n"
            "  ou 'smartwatch_running_watch' pra notícia técnica/dados. Jamais\n"
            "  deixe BG_IMAGE em branco em news.\n"
